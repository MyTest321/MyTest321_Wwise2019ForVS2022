...
void DemoSpatialAudio::InitControls_Portals()
{
	...
	// Also register a room using the default room ID kOutdoorRoomID. This room is already created automatically, but we want to customize its settings by
	// giving it a name, "Outside Object", and setting its auxiliary bus to a bus on which we have mounted a reverb effect.
