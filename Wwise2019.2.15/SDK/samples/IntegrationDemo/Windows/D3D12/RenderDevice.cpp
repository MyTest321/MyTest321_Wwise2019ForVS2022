...
namespace d3d12
{
	RenderDevice& RenderDevice::Instance()
	{
		...
		static RenderDeviceGX instance;
#else
	...
	// Windows rendering uses GXDI swapchains
	...
	ComPtr<ID3D12Device> RenderDeviceGX::CreateDevice()
	{
		...
		device->SetName(L"RendererGX");

		return device;
	}

	// Register frame events
	void RenderDeviceGX::CreateSwapChain()
	{
	...
	void RenderDeviceGX::UpdateRenderTargetViews()
	{
	...
	void RenderDeviceGX::BeginFrame()
	{
		// Throttle
